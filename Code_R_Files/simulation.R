...
write.csv(BAU, "BAU.csv")
write.csv(percent_10_10a_wEV, "percent_10_10a_wEV.csv")
write.csv(percent_50_10a_wEV, "percent_50_10a_wEV.csv")
write.csv(percent_99_10a_wEV, "percent_99_10a_wEV.csv")
write.csv(percent_10_20a_wEV, "percent_10_20a_wEV.csv")
write.csv(percent_50_20a_wEV, "percent_50_20a_wEV.csv")
write.csv(percent_99_20a_wEV, "percent_99_20a_wEV.csv")
write.csv(percent_10_30a_wEV, "percent_10_30a_wEV.csv")
write.csv(percent_50_30a_wEV, "percent_50_30a_wEV.csv")
write.csv(percent_99_30a_wEV, "percent_99_30a_wEV.csv")
...
write.csv(percent_0, "case_0000.csv")
write.csv(case_1000, "case_1000.csv")
write.csv(case_0100, "case_0100.csv")
write.csv(case_0010, "case_0010.csv")
write.csv(case_0001, "case_0001.csv")
write.csv(case_1100, "case_1100.csv")
write.csv(case_1010, "case_1010.csv")
write.csv(case_1001, "case_1001.csv")
write.csv(case_0110, "case_0110.csv")
write.csv(case_0011, "case_0011.csv")
write.csv(case_0101, "case_0101.csv")
write.csv(case_1110, "case_1110.csv")
write.csv(case_1101, "case_1101.csv")
write.csv(case_1011, "case_1011.csv")
write.csv(case_0111, "case_0111.csv")
write.csv(case_1111, "case_1111.csv")
