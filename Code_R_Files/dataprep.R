...
typeChars = read.xlsx("generators_new.xlsx", sheet = "CF_Operating_Retired_Data")
...
retiredGen = read.xlsx("generators_new.xlsx", sheet="Retired and Canceled 2")
...
addCap = read.xlsx("AEOprojections.xlsx", sheet="Sheet3", rowNames=TRUE, colNames = FALSE)
addCap$X29=NULL
...
current.gen = read.xlsx("generators_new.xlsx", sheet= "Operable", startRow = 2)
...
totalCapacity = read.xlsx("AEOprojections.xlsx", sheet = "Sheet2")
...
totalEnergy = read.xlsx("generators_new.xlsx", sheet="Electricity_Demand")
